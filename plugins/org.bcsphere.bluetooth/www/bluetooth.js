...
*/
  ...
  var bluetooth = {
    ...
    connectDevice: function (successFunc, errorFunc, deviceAddress, appID) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'connect', [
        { deviceAddress: deviceAddress, appID: appID },
      ]);
    },

    disconnectDevice: function (successFunc, errorFunc, deviceAddress, appID) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'disconnect', [
        { deviceAddress: deviceAddress, appID: appID },
      ]);
    },

    discoverServices: function (successFunc, errorFunc, deviceAddress) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'getServices', [
        { deviceAddress: deviceAddress },
      ]);
    },

    discoverCharacteristics: function (successFunc, errorFunc, deviceAddress, serviceIndex) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'getCharacteristics', [
        { deviceAddress: deviceAddress, serviceIndex: serviceIndex },
      ]);
    },
    ...
    discoverDescriptors: function (
      ...
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'getDescriptors', [
        {
          deviceAddress: deviceAddress,
          serviceIndex: serviceIndex,
          characteristicIndex: charcteristicIndex,
        },
      ]);
    },
    ...
    readCharacteristic: function (
      ...
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'readValue', [
        {
          deviceAddress: deviceAddress,
          serviceIndex: serviceIndex,
    ...
    writeCharacteristic: function (
      ...
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'writeValue', [
        {
          deviceAddress: deviceAddress,
          serviceIndex: serviceIndex,
          characteristicIndex: characteristicIndex,
    ...
    subscribe: function (
      ...
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'setNotification', [
        {
          deviceAddress: deviceAddress,
          serviceIndex: serviceIndex,
          characteristicIndex: characteristicIndex,
    ...
    notify: function (successFunc, errorFunc, uniqueID, characteristicIndex, data) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'notify', [
        { uniqueID: uniqueID, characteristicIndex: characteristicIndex, data: data },
      ]);
    },
    ...
    getDeviceAllData: function (successFunc, errorFunc, deviceAddress) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'getDeviceAllData', [
        { deviceAddress: deviceAddress },
      ]);
    },

    getRSSI: function (successFunc, errorFunc, deviceAddress) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'getRSSI', [
        { deviceAddress: deviceAddress },
      ]);
    },
    ...
    removeService: function (successFunc, errorFunc, uniqueID) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'removeServices', [
        { uniqueID: uniqueID },
      ]);
    },
    ...
    createPair: function (successFunc, errorFunc, deviceAddress) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'createPair', [
        { deviceAddress: deviceAddress },
      ]);
    },

    removePair: function (successFunc, errorFunc, deviceAddress) {
      cordova.exec(successFunc, errorFunc, 'BCBluetooth', 'removePair', [
        { deviceAddress: deviceAddress },
      ]);
    },
    ...
    addEventListener: function (callback, errorFunc, arg) {
      cordova.exec(callback, errorFunc, 'BCBluetooth', 'addEventListener', [
        { eventName: arg.eventName, arg: arg.arg },
      ]);
    },
  };
