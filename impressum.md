...
<div id="impressum-content" class="impressum-page">
  <div class="legal-container">
    
    <header class="legal-header">
      <h1 class="legal-title">Impressum</h1>
      <p class="legal-subtitle">Angaben gemäß § 5 DDG</p>
    </header>
    ...
    <section class="legal-section">
      ...
      <p class="legal-text">
        ...
        Weitere Datenverarbeitungen: <a href="/datenschutz" class="legal-link">Datenschutzerklärung</a>.
      </p>
    </section>

    <section class="legal-section contact-info">
      <h2 class="section-heading">Angaben gemäß § 5 DDG</h2>
    ...
    <footer class="legal-footer">
      <div class="footer-content">
        ...
        <p class="footer-note">
          Dieses Impressum entspricht den Anforderungen des § 5 DDG.
        </p>
      </div>
    </footer>
