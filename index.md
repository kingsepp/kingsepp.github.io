...
<div id="main-turnstile-protection" style="display: none; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;">
  ...
  <p style="color: #cbd5e1; margin-bottom: 2rem;">Bitte bestätigen Sie, dass Sie ein Mensch sind, um die Website zu nutzen.</p>
...
<section id="home" class="hero">
  ...
  <div class="hero-content">
    ...
    <p class="hero-subtitle">
      Einblick in ausgewählte Projekte und Entwicklungen im Bereich
      künstliche Intelligenz, Cloud-Technologien und moderner Softwareentwicklung.
    </p>
  ...
  <div class="container">
    ...
    <div class="services-grid">
      ...
      <div class="service-card">
        ...
        <h3>AI4MBSE</h3>
        <p>KI-gestütztes Plugin für Model-Based Systems Engineering (MBSE) mit Eclipse Papyrus. Experimentelle und innovative Ansätze zur Systemmodellierung mithilfe künstlicher Intelligenz.</p>
      ...
      <div class="service-card" style="opacity: 0.6;">
        ...
        <p>Weitere persönliche Projekte und Experimente werden in Kürze ergänzt. Diese Website befindet sich im Aufbau und dient ausschließlich privaten, nicht-kommerziellen Informationszwecken.</p>
        <div style="margin-top: 1.5rem;">
      ...
      <div class="service-card" style="opacity: 0.6;">
        ...
        <p>Weitere Inhalte folgen. Die Seite wird fortlaufend erweitert und zeigt ausschließlich private, nicht-kommerzielle Projekte.</p>
        <div style="margin-top: 1.5rem;">
          <span style="color: #64748b; font-size: 0.9rem;">Demnächst verfügbar</span>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="about-grid">
      ...
      <div class="about-text">
        ...
        <p><strong>Hinweis:</strong> Diese Website befindet sich im Aufbau und dient ausschließlich privaten, nicht-kommerziellen Informationszwecken. Es werden keine Dienstleistungen oder Produkte angeboten.</p>
        <p>Die hier gezeigten Projekte repräsentieren persönliche Lernarbeiten, Konzeptstudien und experimentelle Entwicklungen im Bereich moderner Softwaretechnologien.</p>
      </div>
